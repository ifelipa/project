...
//		insertIngredient(8, "wheat flour", 2, 341.0, 90.6, 9.86, 0.0, 2.0, "250");
//		insertIngredient(8, "water", 3, 0, 0, 0, 0, 0, "200");
//		insertIngredient(9, "yeast", 2, 164.0, 27.80, 11.8, 0, 3600.00, "100");
...
//		createProcediment(11, "Bake in oven ");
	...
	private static void createStepXRecipe(int cod_procedure, int cod_ingredient, int quantity, String time, double temperature, int cod_recipe) {
	...
	private static void createRecipe(int code, String name, int quantity, double kcal, double carbohidrates, double proteines, double fat, double salt, String aler  ) {
		Connection conexion= null;
		PreparedStatement pr=null;
	...
	private static void insertIngredient(int code, String name, int measuringCode, double kcal, double carbohidrates, double proteines, double fat, double salt, String quantity) {
		Statement st = null;
		try {
