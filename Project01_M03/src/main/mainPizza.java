...
public class mainPizza {
	...
	public static void main(String[] args) {
		//
		// insertIngredient(7, "wheat flour", 2, 341.0, 90.6, 9.86, 0.0, 2.0,
		// "250");
		// insertIngredient(8, "water", 3, 0, 0, 0, 0, 0, "200");
		// insertIngredient(9, "yeast", 2, 164.0, 27.80, 11.8, 0, 360.00,
		// "100");
		// insertIngredient(10, "olive oil", 3, 900.0, 1.0, 0.0, 0, 0.0, "20");
		// insertIngredient(11, "shredded cheese", 2, 392.84, 25.39, 0.36, 0,
		// 675, "150");
		// insertIngredient(12, "Tomate sauce", 3, 38.1, 2.30, 5.55, 0, 990,
		// "200");
		//
